...
public:
   ...
   * otherwise
   */
  nsresult Start(ToggleBtResultTask* aResultRunnable);
   ...
   * otherwise
   */
  nsresult Stop(ToggleBtResultTask* aResultRunnable);
...
protected:
  ...
  nsresult StartStopBluetooth(ToggleBtResultTask* aResultRunnable, bool aStart);
